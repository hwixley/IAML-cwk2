  ...
  \medskip
   ...
   \begin{subquestion}{(3 points)
      ...
      \begin{answerbox}{52em}
        ...
        \footnotesize{
        This dendogram is very useful as it visually illustrates how each cluster from our dataset is composed and thus ultimately gives significant insight into the hierarchy of similarities between the classes in our data. This visualization makes it easy for us to identify the optimal linkage method based on the classes in our data. Once we have this optimal linkage we can use the resulting dendogram for determining the optimal number of clusters to fit to our data (typically we want a cluster for each class).\\
\\
