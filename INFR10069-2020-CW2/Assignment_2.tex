  ...
  \end{answerbox}
   ...
   \begin{subquestion}{(3 points)
      ...
      \begin{answerbox}{50em}
        ...
        The explained variance ratio for a given principal component represents the variance of that principal component divided by the total variance. Thereby results of this graph showing the relationship between the cumulative explained ratio and the number of principal components (K)
      \end{answerbox}
  ...
  \medskip
   ...
   \begin{subquestion}{(5 points)
      ...
      \begin{answerbox}{55em}
        \includegraphics[width=1\textwidth]{images/q34ward.png}
        \includegraphics[width=1\textwidth]{images/q34single.png}
        \includegraphics[width=1\textwidth]{images/q34complete.png} 
      \end{answerbox}
