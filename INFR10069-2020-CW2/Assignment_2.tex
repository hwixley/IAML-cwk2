  ...
  \medskip
   ...
   \begin{subquestion}{(3 points)
      ...
      \begin{answerbox}{52em}
        ...
        \\
        \\
        This dendogram illustrates how each cluster from our dataset is composed and thus ultimately represents the hierarchy of similarities between the classes in our data. Instead of measuring the distance directly Ward linkage analyzes the variance of clusters.\\
        \\
