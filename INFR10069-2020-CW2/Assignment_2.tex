  ...
  \end{answerbox}
   ...
   \begin{subquestion}{(3 points)
    ...
    \begin{answerbox}{15em}
       \includegraphics[width=1\textwidth]{images/q13.png}
    \end{answerbox}
   ...
   \begin{subquestion}{(5 points)
      ...
      \begin{answerbox}{28em}
        ...
        \begin{tabular}{ |c|c|c|c|c|c| } \hline
            ...
            Class = 0 & 0.256 & 0.15 & 0.128 & 0.062 \\
            Class = 1 & 0.198 & 0.14 & 0.095 & 0.037 \\
            Class = 2 & 0.199 & 0.146 & 0.123 & 0.08 \\
            Class = 3 & 0.146 & 0.107 & 0.084 & 0.056 \\
            Class = 4 & 0.118 & 0.103 & 0.088 & 0.046 \\
            Class = 5 & 0.181 & 0.159 & 0.142 & 0.091 \\
            Class = 6 & 0.129 & 0.096 & 0.072 & 0.046 \\
            Class = 7 & 0.166 & 0.128 & 0.106 & 0.062 \\
            Class = 8 & 0.223 & 0.145 & 0.123 & 0.093 \\
  ...
  \medskip
   ...
   \begin{subquestion}{(3 points)
      ...
      \begin{answerbox}{40em}
        ...
        \\
        From this we can deduce that Dutch and Spanish have the most similar mean vectors and thereby are the most "similar" languages. In contrast we can see that Latvian has the most dissimilar mean vector from all other languages and thereby is the most "unique" language.
      \end{answerbox}
