...
\\
      I believe a cut where distance $\approx 0.85$ (resulting in 5 clusters) would be most optimal due to the large merge clustering distance found after this cut, and also due to the fact we have lots of classes (22) and thereby we would prefer more clusters to represent more detail in our data.
        }
      \end{answerbox}
