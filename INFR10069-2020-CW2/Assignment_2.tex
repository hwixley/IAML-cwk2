...
\begin{question}{(20 total points) Clustering and Gaussian Mixture Models}  
  ...
  \medskip
   ...
   \begin{subquestion}{(3 points)
      ...
      \begin{answerbox}{35em}
        \begin{center}
         \includegraphics[width=0.63\textwidth]{images/q32labelled.png}
        \end{center}
 %       \footnotesize{\textbf{\underline{Analysis of our results}}}\\
%\\
        \scriptsize{
        As expected, we can see that most of the mean class vectors and clusters lie in the same general region of the plot with a few clusters more sparsely decorated. We can imagine these sparse clusters account for outliers in our data given that all the mean classes are in the same general region. \\
\\
        We can see that a few of these clusters are very close to certain class means. Firstly, 
